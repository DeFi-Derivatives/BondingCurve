...
class FA12_mint_burn(FA12_core, ContractLibrary):
    ...
    def burn(self, params):
        ...
        sp.verify(sp.sender == params.address, message = "Invalid Sender")
...
if "templates" not in __name__:
    ...
    def test():
        ...
        scenario.h1("USD FA1.2 Token Template")
        ...
        token_metadata = {
            ...
            # Extra fields
            "icon"        : 'https://raw.githubusercontent.com/DeFi-Derivatives/Icon-pack/master/dollar-symbol.png'
        }
        contract_metadata = {
            "" : "ipfs://bafkreigukv6qk3mcwi75ajql6nmyxotx4z3klfpn7hpsgh4sqgq3eqhuf4",
        }
        c1 = FA12(
            admin,
            ...
            sp.some(
                sp.record(
                    ...
                    token_info = sp.map({
                        ...
                        "name"        : sp.utils.bytes_of_string("USD Test Token"),
                        "symbol"      : sp.utils.bytes_of_string("USD"),
                        "icon"        : sp.utils.bytes_of_string('https://raw.githubusercontent.com/DeFi-Derivatives/Icon-pack/master/dollar-symbol.png')
                    })
                )
            )
        )
        ...
        scenario.verify(
            c1.data.metadata[""] == sp.utils.bytes_of_string("ipfs://bafkreigukv6qk3mcwi75ajql6nmyxotx4z3klfpn7hpsgh4sqgq3eqhuf4")
        )
        ...
        scenario.verify(c1.data.balances[admin].balance == 100 * DECIMAL)    
        ...
        scenario.verify(c1.data.balances[alice.address].balance == 16 * DECIMAL )
        ...
        c1.burn(address = bob.address, value = 1 * DECIMAL).run(sender = bob)

        scenario.verify(c1.data.balances[alice.address].balance == 12 * DECIMAL)
        ...
        scenario.verify(c1.data.balances[alice.address].balance == 11 * DECIMAL)
        scenario.verify(c1.data.balances[bob.address].balance == 8 * DECIMAL)
